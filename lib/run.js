// Require and return is/mock/log, only if used.
if (!global.is) {
  Object.defineProperty(global, 'is', {
    get: function () { return (global.is = require('./is')); }
  });
}
if (!global.mock) {
  Object.defineProperty(global, 'mock', {
    get: function () { return (global.mock = require('./mock')); }
  });
}
...
function prepareError(e) {
  var stack = e.stack.replace(parserExp, function (match, slice) {
    var pos = currentPath + ':';
    // Acorn.
    if (e.loc) {
